...
public class CalendarFragment extends Fragment implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener {
    ...
    public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        final List<WeekViewEvent> eventsList = new ArrayList<WeekViewEvent>();
            ...
            public void done(List<ParseObject> objects, com.parse.ParseException e) {
                if (e == null) {
                    for (int i = 0; i < objects.size(); i++) {
                        ...
                        WeekViewEvent events = new Event(
                                1,
                                eventName,
                                location,
                                startTime,
                        ...
                        events.setColor(getResources().getColor(R.color.event_color_02));
        ...
        Log.d("Shelter", startTime.toString());
...
/*        startTime = Calendar.getInstance();
    ...
    public void onEventClick(WeekViewEvent event, RectF eventRect) {
        ...
        Log.d("Shelter", "to event popup activity");
